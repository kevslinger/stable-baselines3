...
class BeliefHerReplayBuffer(DictReplayBuffer):
    """
    ...
    def __init__(
        ...
        super(BeliefHerReplayBuffer, self).__init__(buffer_size, env.observation_space, env.action_space, device, env.num_envs)
