...
class RecurrentBeliefHerReplayBuffer(DictReplayBuffer):
    """
    ...
    def __init__(
        ...
        super(RecurrentBeliefHerReplayBuffer, self).__init__(buffer_size, env.observation_space, env.action_space, device, env.num_envs)
