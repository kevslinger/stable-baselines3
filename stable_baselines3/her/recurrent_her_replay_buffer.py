...
class RecurrentHerReplayBuffer(DictReplayBuffer):
    """
    ...
    def __init__(
        ...
        super(RecurrentHerReplayBuffer, self).__init__(buffer_size, env.observation_space, env.action_space, device, env.num_envs)
